...
@Configuration
@EnableJpaRepositories(basePackages = { "demo.locations"}, entityManagerFactoryRef = "locationEntityManagerFactory", transactionManagerRef = "locationTransactionManager")
