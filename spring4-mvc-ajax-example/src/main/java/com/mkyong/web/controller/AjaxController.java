...
public class AjaxController
{
	...
	public ModelAndView getSearchResultViaAjax(SearchCriteria search)
	{

		System.out.println(search.getEmail());
		System.out.println(search.getUsername());

		CurrentTenantId.set(search.getUsername());

		dataProcessor.getCustomersCustom();

		for (Customer l : dataProcessor.getCustomers())
		{
			//System.out.println("Customer Name "+l.getName());
		}
